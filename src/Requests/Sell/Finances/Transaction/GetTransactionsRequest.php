...
use Sashalenz\EbayApi\Data\Sell\Finances\TransactionsData;
use Sashalenz\EbayApi\Requests\Request;

/**
 * Get Transactions Request
 *
 * Retrieves the details of monetary transactions matching search criteria.
 */
class GetTransactionsRequest extends Request
{
    ...
    {
        return '/sell/finances/v1/transaction';
    }
