 ...
 *
 * Retrieves product compatibility property values associated with a single property name.
 */
class GetCompatibilityPropertyValuesRequest extends Request
{
    ...
    {
        return '/sell/metadata/v1/compatibilities/get_compatibility_property_values';
    }
