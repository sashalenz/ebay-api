...
/**
 * Create Inventory Location Request
 *
 * Creates a new inventory location.
 */
class CreateInventoryLocationRequest extends Request
{
    ...
    protected function validate(): array
    {
        ...
        if ($this->location === null) {
            $errors[] = 'Location data (address) is required';
        }

        if (empty($this->locationTypes)) {
            $errors[] = 'At least one location type is required';
        }
