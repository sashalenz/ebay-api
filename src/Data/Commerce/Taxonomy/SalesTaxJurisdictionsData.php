 ...
 *
 * @see https://developer.ebay.com/api-docs/commerce/taxonomy/types/txn:SalesTaxJurisdiction
 */
class SalesTaxJurisdictionsData extends Data
{
    /**
     * Create a new Sales Tax Jurisdictions Data instance
     *
